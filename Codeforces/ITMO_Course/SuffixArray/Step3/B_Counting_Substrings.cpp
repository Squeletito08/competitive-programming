...
int lower_bound_bs(vi &p, string &s, string &t)
{
    int l = 0;
    int r = sz(p) - 1;
...
int upper_bound_bs(vi &p, string &s, string &t)
{
    int l = 0;
    int r = sz(p) - 1;
...
void solve()
{
    ...
    while (q--)
    {
        ...
        int low = lower_bound_bs(p, s, buscar);
        ...
        int upper = upper_bound_bs(p, s, buscar);
        cout << upper - low + 1 << endl;
    }
}
